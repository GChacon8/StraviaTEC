...
public class UnirseGrupoController : ControllerBase
{
    ...
    public UnirseGrupoController(IConfiguration configuration)
    {
    ...
    public IActionResult UnirseGrupo([FromForm] string nombreDeportista, [FromForm] int idGrupo)
    {
        try
        {
            string mensaje = "";
            ...
            using (SqlConnection connection = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("UnirseGrupo", connection))
                {
                    ...
                    cmd.Parameters.Add(new SqlParameter("@ID_Grupo", SqlDbType.Int) { Value = idGrupo });
